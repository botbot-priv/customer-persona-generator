...
summary = pd.read_csv('/workspaces/customer-persona-generator/data/summary_result.csv')
group = summary.group
...
for i, tab in enumerate(tabs):
    with tab:
        ...
        with col1:
            # Name
            name_df = pd.read_csv('/workspaces/customer-persona-generator/data/name_list.csv')
